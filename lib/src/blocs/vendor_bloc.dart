...
import 'package:MarketingApp/src/services/firebase_storage_service.dart';
...
class VendorBloc {
  ...
  final validateDescription = StreamTransformer<String,String>.fromHandlers(handleData: (description,sink){
   if(description != null){
     if(description.length >= 10 && description.length <= 200 ){
      ...
      if (description.length < 3){
        ...
        sink.addError('200 Charater Maximum');
      }
    }
  ...
  pickImage() async{
    ...
    if(image != null) {
      ...
      .uploadVendorImage(compressedFile, uuid.v4()); 
