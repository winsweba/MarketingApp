      ...
      builder: (context, snapshot) {
        return Column(
          children: [
            ...
            : Center( child: AppButton(buttonText: 'Create a vender Profile',
            buttonType: ButtonType.LightBlue, onPressed: () => Navigator.of(context).pushNamed('/editvendor') ) ), 
            ),
            Container(
              height: 50.0,
              child:(Platform.isIOS)
        ? CupertinoButton(
          child: Text('Logout', style: TextStyle(color: AppColors.straw)), 
